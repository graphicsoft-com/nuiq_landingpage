    ...
    <div class="container">
        <div class="section article">
            ...
            if(isset($_GET['article'])) {
                ...
                $article = preg_replace('/[^a-zA-Z0-9-_]/', '', $article);


                $filePath = "articles/{$article}.md"; // assuming the articles are stored in an 'articles' directory

                // Check if the file exists
                if(file_exists($filePath)) {
                    echo $Parsedown->text(file_get_contents($filePath));
                } else {
                    echo "The requested article could not be found.";
                }
            } else {
